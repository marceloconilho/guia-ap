...
- **`masterpower-r4449-regis`** — 🟡 Ficha comercial revenda. Faixa 145–360 hp **declarada**; A/R .48 monofluxo.  
  Fonte: https://www.regisracing.com.br/turbinas/master-power-turbo-r4449-2-145-360-hp-44-05-x-49-5
- **`autoavionics-a50-236m`** — 🟡 Ficha comercial. A/R .36 monofluxo; opção spool cedo.  
  Fonte: https://autoavionics.com.br/produto/a50-2-36m/
- **`autoavionics-a50-248p`** — 🟡 Ficha comercial. A/R .48 pulsativa; recomendação Projeto Marcelo.  
  Fonte: https://autoavionics.com.br/produto/a50-2-48p/
- **`garrett-g25-550`** — 🔬 Fabricante oficial. Mapa e faixa HP declarada; referência premium.  
  Fonte: https://www.garrettmotion.com/racing-and-performance/performance-catalog/turbo/g-series-g25-550/
- **`garrett-g25-660`** — 🔬 Fabricante oficial. Capacidade de topo; mapa oficial.  
  Fonte: https://www.garrettmotion.com/racing-and-performance/performance-catalog/turbo/g-series-g25-660/
- **`garrett-g25-sell-sheet`** — 🔬 PDF oficial Garrett. Tabela comparativa G25-550 / G25-660.  
  Fonte: https://www.garrettmotion.com/wp-content/uploads/2020/10/Garrett_Performance_G-25_Turbochargers_Sell_Sheet_10_21.pdf
- **`borgwarner-efr-6258`** — 🔬 Fabricante oficial. EFR 6258; mapa compressor PDF.  
  Fonte: https://www.borgwarner.com/docs/default-source/iam/boosting-technologies/efr-6258-a.pdf?sfvrsn=595bb03c_17

> ⚠️ **Fonte de confiabilidade limitada**: fichas 🟡 de revenda (Master Power, Auto Avionics via loja). Faixa HP é **declarada**, não medida no AP. Cruzar sempre com mapa 🔬 do fabricante quando existir.
